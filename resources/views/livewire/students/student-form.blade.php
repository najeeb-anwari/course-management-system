                ...
                <div class="mb-3">
                    @if ($student->photo_name || $photo)
                        <div style="position: relative; max-width: min-content;">
                            ...
                            <img class="rounded" style="max-width: 150px" src="{{ $photo?->temporaryUrl() ?? asset('storage' . $student->photo_path . $student->photo_name) }}">
                        </div>
                    @endif
                </div>
